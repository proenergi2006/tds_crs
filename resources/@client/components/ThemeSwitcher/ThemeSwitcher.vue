...
const themeImages = import.meta.glob<{
  default: string;
}>("/resources/@client/assets/images/themes/*.{jpg,jpeg,png,svg}", { eager: true });
const layoutImages = import.meta.glob<{
  default: string;
}>("/resources/@client/assets/images/layouts/*.{jpg,jpeg,png,svg}", { eager: true });
</script>
                  ...
                  >
                    ...
                    >
                      <img
                        ...
                        :src="
                          themeImages[
                            '/resources/@client/assets/images/themes/' + theme + '.png'
                          ].default
                        "
                  ...
                  >
                    <div class="w-full h-full overflow-hidden rounded-md">
                      <img
                        ...
                        :src="
                          layoutImages[
                            '/resources/@client/assets/images/layouts/' + layout + '.png'
                          ].default
                        "
                        alt="Midone - Admin Dashboard Template"
                      />
