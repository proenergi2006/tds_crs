<!-- src/pages/VendorPoCreate.vue -->
<template>
    <div class="py-2 bg-slate-100 min-h-screen">
      <div class="intro-y box p-5 mx-auto max-w-12xl mt-8">
        <h2 class="text-lg font-medium mb-4">Add Vendor PO</h2>
        ...
        <div class="grid grid-cols-12 gap-4 mb-6">
          ...
          <div class="col-span-12 sm:col-span-12 flex items-start space-x-4">
  <label class="flex items-center space-x-2">
    <input type="checkbox" v-model="termsChecked" class="form-checkbox" />
  ...
  placeholder="Isi terms & condition"
...
></textarea>
  ...
  // submit: header lalu batch detail
